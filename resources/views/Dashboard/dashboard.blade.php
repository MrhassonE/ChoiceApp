<x-appDash-layout>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header pb-0 p-3">
                    <h6 class="mb-2">أحصائيات زيارات الأندرويد<img src="{{asset('assetsDashboard/images/android.png')}}" class="avatar-sm" alt=""></h6>
                </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header pb-0 p-3">
                    <h6 class="mb-2">أحصائيات زيارات الأيفون<img src="{{asset('assetsDashboard/images/apple.png')}}" class="avatar-sm" alt=""></h6>
                </div>
                <div class="card-body p-3">
                    <div class="chart">
