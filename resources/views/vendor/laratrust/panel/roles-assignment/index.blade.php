                        ...
                        @foreach($users as $key=>$user)
                                <tr>
                                    ...
                                    <td class="flex justify-end px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                        <a href="{{route('laratrust.roles-assignment.edit', ['roles_assignment' => $user->getKey(), 'model' => $modelKey])}}" class="btn btn-primary btn-round text-light text-blue-600 hover:text-blue-900"><i class="fa fa-pen me-1"></i>تعديل</a>
                                    </td>
                                </tr>
                        @endforeach
                        </tbody>
