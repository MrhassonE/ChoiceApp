!function () {
    ...
    function l(e) {
        document.getElementsByClassName("header-lang-img").forEach(function (t) {
            if (t) {
                ...
                localStorage.setItem("language", e), n = localStorage.getItem("language"), function () {
                    null == n && l(o);
    ...
    function r() {
        ...
        t && t.forEach(function (n) {
            !function t() {
                var e = +n.getAttribute("data-target"), a = +n.innerText, s = e / 250;
    ...
    }), document.addEventListener("fullscreenchange", b), document.addEventListener("webkitfullscreenchange", b), document.addEventListener("mozfullscreenchange", b), function () {
