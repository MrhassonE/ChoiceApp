        ...
        <form method="post" class="needs-validation" novalidate id="UpdateForm" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">تغيير معلومات الخدمة</h4>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="">اسم الخدمة</label>
                                <input id="title" maxlength="50" value="{{$serviceType->title}}" required name="title" type="text" class="form-control" placeholder="ادخل الاسم">
                            ...
                            <div class="row">
                                <div class="col-md-5 my-1">
                                    ...
                                    <input class="form-control" name="color" type="color" value="{{$serviceType->color}}" id="color-input-brand">
                                </div>
                ...
                <div class="col-md-12 my-1">
                    ...
                    <a href="{{route('Setting')}}" class="btn btn-secondary btn-round">ألغاء</a>
                </div>
            </div>
        </form>
    </div>
    <script >
        ...
        $(`#UpdateForm`).on('submit',function (event) {
            ...
            if (validateForm !== false) {
                ...
                $.ajax({
                    type: 'post',
                    url: `{{route('ServiceType.update',$serviceType->id)}}`,
                    data: formData,
                    contentType: false,
                    processData: false,
                    success: function () {
